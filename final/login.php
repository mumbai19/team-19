...
if(isset($_POST["submit"]))
{
	...
	$password=$_["pass"];
	if($username="buyer@gmail.com" && $password="password")
	{
		header("Location: product.php");
	}
	else if($usermame="seller@gmail.com" && $password="password")
	{
		header("Location: product.php");
	}
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" action="login.php" method="post">
					...
					<input class="btn btn-primary btn-user btn-block" type="submit" id="submit" name="submit" value="login" />
                  </form>
                  <hr>
                  <div class="text-center">
